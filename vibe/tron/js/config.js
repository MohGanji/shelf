...
export const DEFAULT_DEV_HUD = {
  ...
  defaultTrailLength: 300,
  maxSpeed: 100,
  maxAcceleration: 70,
  maxHandlingRadPerSec: 6.0,
  maxNitroBars: 6,
  playerBaseTrailLength: 300,
  enemyBaseTrailLength: 300,
  playerTrailUpgradeMaxPercent: 50,
  playerBasePercent: 66,
  enemyEasyPercent: 55,
  enemyMediumPercent: 77,
  enemyHardPercent: 88,
  enemyBossPercent: 97,
  ...
  aiSafetyPercent: 93,
  aiAggressionPercent: 88,
  aiCutoffPercent: 93,
  aiPressurePercent: 93,
  aiLookaheadPercent: 88,
  aiStabilityPercent: 51,
  aiAggression: 1.0,
  aiReactionTime: 0.5,
